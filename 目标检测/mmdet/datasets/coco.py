...
class CocoDataset(BaseDetDataset):
    ...
    METAINFO = {
        'classes': (
            ...
            'rice gall midge', 'Rice Stemfly', 'brown plant hopper', 'white backed plant hopper',
            ...
            'Dacus dorsalis(Hendel)', 'Bactrocera tsuneonis',
            'Prodenia litura', 'Adristyrannus', 'Phyllocnistis citrella Stainton', 'Toxoptera citricidus',
            'Toxoptera aurantii',
