...
from ultralytics8.utils import ASSETS, WEIGHTS_DIR


def test_checks():
    """Validate CUDA settings against torch CUDA functions."""
    print(f"CUDA_IS_AVAILABLE: {CUDA_IS_AVAILABLE}, \nCUDA_DEVICE_COUNT: {CUDA_DEVICE_COUNT}")
...
def test_autobatch():
    ...
    from ultralytics8.utils.autobatch import check_train_batch_size
...
def test_predict_sam():
    ...
    from ultralytics8 import SAM
    from ultralytics8.models.sam import Predictor as SAMPredictor
