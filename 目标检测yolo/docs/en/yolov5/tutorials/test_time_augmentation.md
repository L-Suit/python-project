...
Downloading https://github.com/ultralytics11/yolov5/releases/download/v5.0/yolov5s.pt to yolov5s.pt...
...
# Model
model = torch.hub.load("ultralytics11/yolov5", "yolov5s")  # or yolov5m, yolov5x, custom
