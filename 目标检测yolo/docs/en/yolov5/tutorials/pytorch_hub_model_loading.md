...
# Model
model = torch.hub.load("ultralytics11/yolov5", "yolov5s")
...
```python
model = torch.hub.load("ultralytics11/yolov5", "yolov5s", device="cpu")  # load on CPU
```
...
```python
model = torch.hub.load("ultralytics11/yolov5", "yolov5s", _verbose=False)  # load silently
```
...
```python
model = torch.hub.load("ultralytics11/yolov5", "yolov5s", channels=4)
```
...
```python
model = torch.hub.load("ultralytics11/yolov5", "yolov5s", classes=10)
```
...
```python
model = torch.hub.load("ultralytics11/yolov5", "yolov5s", force_reload=True)  # force reload
```
...
# Models
model0 = torch.hub.load("ultralytics11/yolov5", "yolov5s", device=0)
model1 = torch.hub.load("ultralytics11/yolov5", "yolov5s", device=1)
...
model = torch.hub.load("ultralytics11/yolov5", "yolov5s", autoshape=False)  # load pretrained
model = torch.hub.load("ultralytics11/yolov5", "yolov5s", autoshape=False, pretrained=False)  # load scratch
```
...
model = torch.hub.load("ultralytics11/yolov5", "custom", path="path/to/best.pt")  # local model
...
model = torch.hub.load("ultralytics11/yolov5", "custom", path="yolov5s.pt")  # PyTorch
model = torch.hub.load("ultralytics11/yolov5", "custom", path="yolov5s.torchscript")  # TorchScript
model = torch.hub.load("ultralytics11/yolov5", "custom", path="yolov5s.onnx")  # ONNX
model = torch.hub.load("ultralytics11/yolov5", "custom", path="yolov5s_openvino_model/")  # OpenVINO
model = torch.hub.load("ultralytics11/yolov5", "custom", path="yolov5s.engine")  # TensorRT
model = torch.hub.load("ultralytics11/yolov5", "custom", path="yolov5s.mlmodel")  # CoreML (macOS-only)
model = torch.hub.load("ultralytics11/yolov5", "custom", path="yolov5s.tflite")  # TFLite
model = torch.hub.load("ultralytics11/yolov5", "custom", path="yolov5s_paddle_model/")  # PaddlePaddle
```
