...
```bash
zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/base-none
zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/pruned65_quant-none
```
...
# create Pipeline
model_stub = "zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/pruned65_quant-none"
...
deepsparse.server \
    --task yolo \
    --model_path zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/pruned65_quant-none
```
...
```bash
deepsparse.object_detection.annotate --model_filepath zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/pruned65_quant-none --source basilica.jpg
```
...
```bash
deepsparse.benchmark zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/base-none -s sync -b 32 -nstreams 1 -e onnxruntime

> Original Model Path: zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/base-none
> Batch Size: 32
> Scenario: sync
...
```bash
deepsparse.benchmark zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/base-none -s sync -b 32 -nstreams 1
...
```bash
deepsparse.benchmark zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/pruned65_quant-none -s sync -b 32 -nstreams 1

> Original Model Path: zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/pruned65_quant-none
> Batch Size: 32
> Scenario: sync
...
```bash
deepsparse.benchmark zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/base-none -s sync -b 1 -nstreams 1 -e onnxruntime
...
```bash
deepsparse.benchmark zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/pruned65_quant-none -s sync -b 1 -nstreams 1
...
```bash
deepsparse.benchmark zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/pruned35_quant-none-vnni -s sync -b 1 -nstreams 1

> Original Model Path: zoo:cv/detection/yolov5-s/pytorch/ultralytics11/coco/pruned35_quant-none-vnni
> Batch Size: 1
> Scenario: sync
